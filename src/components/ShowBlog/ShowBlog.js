...
function ShowBlog(props, p) {
  return (
    <div className={`col-md-4 col-sm-6 col-xs-12 ${c.grid}`}>
      <div className={`h-100 ${c.cardsmall}`}>
        <div
        ...
        <div className="card-body m-4">
          <h5 className="card-title cus-title mt-4 mb-4 text-decoration-none text-left">
            <Link
              to={encodeURIComponent(props.title.trim())}
              className={`text-decoration-none ${c.textfiordblue}`}
            >
              {props.title}
            </Link>
          </h5>
          ...
          <div className={`row`}>
            <span className="text-dark col-md-6 col-sm-6 col-xs-12 text-start">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fas"
            ...
            <span className="text-dark col-md-6 col-sm-6 col-xs-12 text-end">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fas"
